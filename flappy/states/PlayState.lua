...
PIPE_SPAWN_MIN_TIME_SEC = 2
PIPE_SPAWN_MAX_TIME_SEC = 4
...
function PlayState:init()
    ...
    self.timer = 0
    self.score = 0
    self.pipeSpawnThreshold = math.random(PIPE_SPAWN_MIN_TIME_SEC, PIPE_SPAWN_MAX_TIME_SEC)
...
function PlayState:update(dt)
    ...
    if self.timer > self.pipeSpawnThreshold then
